...
const skills = [
  ...
  // Backend
  { name: "Node.js", level: 99, category: "Backend" },
  { name: "Express.js", level: 99, category: "Backend" },
  { name: "MongoDB", level: 95, category: "Backend" },
  { name: "MySQL", level: 99, category: "Backend" },
  { name: "Socket.io", level: 80, category: "Backend" },

  // Cloud & Tools
  { name: "AWS", level: 95, category: "Cloud & Tools" },
  { name: "Git/GitHub", level: 99, category: "Cloud & Tools" },
  { name: "Docker", level: 65, category: "Cloud & Tools" },
  { name: "Postman", level: 90, category: "Cloud & Tools" },
